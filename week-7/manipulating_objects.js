...
I didn't have any problems until the children property. I was having trouble conceptualizing the 
children property, the carson property, and the carson object simultaneously. It helped to
break it down into one thing at a time, first creating terah.children. Working from there I knew
that carson had to be a property, so I would have to use either dot or bracket notation. Then I knew 
it would also need to be an object with a name property, so I used the curly braces that denote an
object with the name property inside that. It worked because it added carson as a nested property of
the children property, and also was assigned to the object carson, which could be given a name.

//How difficult was it to add and delete properties outside of the object itself?

It wasn't that difficult, and it simply required remembering the proper notation.

//What did you learn about manipulating objects in this challenge?

I learned a lot, actually. It made the property concept of javascript exceptionally easier to
comprehend, as well as solidified the proper syntax.
